    ...
    <Fragment>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={[commonStyle.categoriseListWrap, { paddingTop: 0 }]}>
          {mainCategoryServises && mainCategoryServises.length
            ? mainCategoryServises.map((mainCategory, pIndex) => (
              <View key={pIndex}>
                <View style={commonStyle.servicecatItem}>
                  <View style={commonStyle.searchBarText}>
                    ...
                    <Text
                      style={[
                        ...
                        {
                          backgroundColor:
                            mainCategory.categoryColor || '#FF9589',
                        },
                      ]}>
                      .
                    </Text>
                  ...
                  {isUpdate ? (
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        isUpdate
                          ? openServiceModal('main', pIndex, null, true)
                          : null;
                      }}>
                      <MoreVertical />
                    </TouchableOpacity>
                ...
                <View style={[commonStyle.setupCardBox]}>
                  {mainCategory.services && mainCategory.services.length
                    ? mainCategory.services.map((item, index) => (
                      <List
                        key={index}
