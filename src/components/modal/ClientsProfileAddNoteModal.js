...
const ClientsProfileAddNoteModal = (props) => {
  ...
  return (
    <View style={commonStyle.modalContent}>
      <View
        ...
        <Text style={[commonStyle.modalforgotheading]}>Add a note</Text>
        ...
        <View style={commonStyle.mb2}>
          ...
          <View
            ...
            <TextInput
              ...
              onChangeText={(text) => props.setNoteTextBoxContent(text)}
              returnKeyType="done"
...
export default ClientsProfileAddNoteModal;
